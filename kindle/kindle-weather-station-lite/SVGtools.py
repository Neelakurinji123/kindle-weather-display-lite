...
class path:
    def __init__(self, d, style, transform=None):
        self.d = d
        self.style = style
    ...
    def svg(self):
        if not self.transform == None:
            return f'<path d="{self.d}" transform="{self.transform}" style="{self.style}"/>\n'
        else:
...
class spline:
    ...
    # */
    #
    #  Translated from javascript to python by krishna@hottunalabs.net
    #
    #
